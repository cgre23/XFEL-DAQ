...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.starttime.setGeometry(QtCore.QRect(20, 150, 194, 22))
        self.starttime.setMinimumDate(QtCore.QDate(2022, 9, 14))
        self.starttime.setCalendarPopup(True)
        self.starttime.setObjectName("starttime")
        self.stoptime = QtWidgets.QDateTimeEdit(self.groupBox_2)
        self.stoptime.setEnabled(False)
        self.stoptime.setGeometry(QtCore.QRect(310, 150, 194, 22))
        self.stoptime.setMinimumDate(QtCore.QDate(2022, 9, 14))
        self.stoptime.setCalendarPopup(True)
        self.stoptime.setObjectName("stoptime")
        self.radioButton = QtWidgets.QRadioButton(self.groupBox_2)
        self.radioButton.setGeometry(QtCore.QRect(20, 120, 301, 20))
    ...
    def retranslateUi(self, Form):
        ...
        self.SASEoptions.setItemText(3, _translate("Form", "LINAC"))
        self.label_4.setText(_translate("Form", "Convert files from:"))
        self.radioButton.setText(_translate("Form", "Override start and stop times"))
